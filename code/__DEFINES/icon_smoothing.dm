...
#define SMOOTH_GROUP_FLOOR_ICE_NAGA S_TURF(33)			///turf/simulated/floor/plating/ice_naga

#define MAX_S_TURF SMOOTH_GROUP_FLOOR_ICE_NAGA //Always match this value with the one above it.
