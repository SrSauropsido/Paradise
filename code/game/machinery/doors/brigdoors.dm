...
/obj/machinery/door_timer
	...
	//HISPANIA
	var/prisoner_charge_minor
	var/prisoner_charge_moderate
	var/prisoner_charge_major

	var/prisoner_minor_details
	var/prisoner_moderate_details
	var/prisoner_major_details
	//HISPANIA

	var/prisoner_time
	var/prisoner_hasrecord = FALSE
	var/datum/ui_module/crimes_menu/cm // CRIMES UI

/obj/machinery/door_timer/New()
 	GLOB.celltimers_list += src
 	cm = new(src) // Preaparar la UI
 	return ..()
...
/obj/machinery/door_timer/proc/print_report()
	...
	for(var/obj/machinery/computer/prisoner/C in GLOB.prisoncomputer_list)
		...
		if(prisoner_minor_details || prisoner_moderate_details || prisoner_major_details) // Print Hispania
			P.info += {"
						<b>Details(s):</b>	[prisoner_minor_details + " " + prisoner_moderate_details + " " + prisoner_major_details]<br>"}
		P.info += {"
	...
	if(R)
		...
		//HISPANIA RECORDS
		if(prisoner_charge_minor)
			R.fields["mi_crim"] = (R.fields["mi_crim"] == "None" ? prisoner_charge_minor : R.fields["mi_crim"] + prisoner_charge_minor)
			if(prisoner_minor_details)
				R.fields["mi_crim_d"] = (R.fields["mi_crim_d"] == "No minor crime convictions." ? prisoner_minor_details : R.fields["mi_crim_d"] + " " + prisoner_minor_details)
		if(prisoner_charge_moderate)
			R.fields["mo_crim"] = (R.fields["mo_crim"] == "None" ? prisoner_charge_moderate : R.fields["mo_crim"] + prisoner_charge_moderate)
			if(prisoner_moderate_details)
				R.fields["mo_crim_d"] = (R.fields["mo_crim_d"] == "No moderate crime convictions." ? prisoner_moderate_details : R.fields["mo_crim_d"] + " " + prisoner_moderate_details)
		if(prisoner_charge_major)
			R.fields["ma_crim"] = (R.fields["ma_crim"] == "None" ? prisoner_charge_major : R.fields["ma_crim"] + prisoner_charge_major)
			if(prisoner_major_details)
				R.fields["ma_crim_d"] = (R.fields["ma_crim_d"] == "No major crime convictions." ? prisoner_major_details : R.fields["ma_crim_d"] + " " + prisoner_major_details)
		//HISPANIA RECORDS
...
/obj/machinery/door_timer/ui_act(action, params)
	...
	switch(action)
		...
		if("clear_crimes")
			...
			prisoner_charge_minor = null
			prisoner_charge_moderate = null
			prisoner_charge_major = null
		if("prisoner_time")
